//Decalración de arreglos 1
Console.ForegroundColor = ConsoleColor.Red;
int[] array1 = new int [3];
array1[0] = 100;
array1[1] = 200;
Console.WriteLine($"array[0] = {array1} y array1[1] ) {array1[1]}");
Console.ReadKey();
...
int[] array2 = { 1, 3, 5, 7 };
string[] array3 = { "Lunes", "Martes", "Miercoles", "Jueves", "Viernes" };
Console.WriteLine($"arrray2[1] = {array2[2]}, array2[3] = {array2[3]} y array3[1] = {array3[1]}");

//Declaración de arreglos 3

Console.ForegroundColor = ConsoleColor.Yellow;
double[] array4;
array4 = new double[] { 1.1, 2.2, 4.4, 3.3 };
...
foreach(int [] item in arrayOfArrays)
{
    ...
    Console.WriteLine($"studesntScore tiene {studentScores.Rank} dimensiones");
    Console.ReadKey();
